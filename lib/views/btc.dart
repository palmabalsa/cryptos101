            ...
            child: FutureBuilder<CoinData>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.hasData) {
                    ...
                    double then25_1_22 =
                        1037.91; //this is a rough currency conversion from SGD($981.07 SGD) - take this one w grain of salt
                        ...
                        child: DataTable(
                          ...
                          rows: [
                            DataRow(cells: [
                              ...
                              DataCell(Text(
                                  '\$${now25_1_22.toStringAsFixed(2)} NZD')),
                              DataCell(Text(
                            ...
                            DataRow(cells: [
                              ...
                              DataCell(Text(
                                  '\$${now18_2_22.toStringAsFixed(2)} NZD')),
                              DataCell(Text(
                                  '\$${gain18_2_22.toStringAsFixed(2)} NZD')),
                            ]),
                            DataRow(cells: [
                              ...
                              DataCell(Text(
                                  '\$${now19_2_22.toStringAsFixed(2)} NZD')),
                              DataCell(Text(
                                  '\$${gain19_2_22.toStringAsFixed(2)} NZD')),
                            ]),
                            DataRow(cells: [
                              ...
                              DataCell(Text(
                                  '\$${now21_2_22_1.toStringAsFixed(2)} NZD')),
                              DataCell(Text(
                                  '\$${gain21_2_22_1.toStringAsFixed(2)} NZD')),
                            ]),
                            DataRow(cells: [
                              DataCell(Text('21/2/22')),
                              ...
                              DataCell(Text(
                                  '\$${now21_2_22_2.toStringAsFixed(2)} NZD')),
                              DataCell(Text(
                                  '\$${gain21_2_22_2.toStringAsFixed(2)} NZD')),
                            ]),
                            DataRow(cells: [
                              ...
                              DataCell(Text(
                                  '\$${now23_2_22.toStringAsFixed(2)} NZD')),
                              DataCell(Text(
