        ...
        child: FutureBuilder<CoinData>(
          ...
          builder: (context, snapshot){
            ...
            if (snapshot.hasData){
              ...
              double then25_1_22 = 1031.46; //rough currency conversion from $974.96SGD
                    ...
                    DataColumn(label: Text('GAIN?')),
                     ...
                     rows: [
                      ...
                      DataRow(cells: [
                        ...
                        DataCell(Text('\$${now9_2_22.toStringAsFixed(2)} NZD')),
                        DataCell(Text('\$${gain9_2_22.toStringAsFixed(2)} NZD')),
                      ]),
                      DataRow(cells: [
                        ...
                        DataCell(Text('\$${now22_2_22.toStringAsFixed(2)} NZD')),
                        DataCell(Text('\$${gain22_2_22.toStringAsFixed(2)} NZD')),
                      ]),
                      DataRow(cells: [
